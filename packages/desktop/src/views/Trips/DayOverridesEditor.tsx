  ...
  return (
    <section className={styles.overrides}>
      ...
      <p className={styles.overridesHint}>
        ...
        Tick <em>no leave</em> if a specific day shouldn't count (an evening flight, a day off
        granted by your employer). <em>Travel day</em> is informational only — it marks the day
        for Schengen day-counting. <em>Half day</em> charges 0.5 instead of 1, but only when
        your cycle allows half-day leave.
      </p>
      {days.map((day) => {
